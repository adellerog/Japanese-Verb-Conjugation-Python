...
class MyTestCase(unittest.TestCase):
    def setUp(self):
        self.verb = t('kuru', 'kimasu')

    def tearDown(self):
        del self.verb

    def test_find_root(self):
        self.assertEqual(t.find_root(self.verb), 'ku')
    ...
    def test_find_plain_negative(self):
        self.assertEqual(t.find_plain_negative(self.verb), 'konai')
    ...
    def test_find_plain_neg_past(self):
        self.assertEqual(t.find_plain_neg_past(self.verb), 'konakatta')
